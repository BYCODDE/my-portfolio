...
export const gridItems = [
  {
    id: 1,
    title:
      "I prioritize working closely with clients, encouraging transparent communication.",
    description: "",
  ...
  {
    id: 4,
    title: "Technology enthusiast driven by a passion for development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a JS based projects",
